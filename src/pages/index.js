  ...
  return (
    <div className="min-h-screen bg-pink-50 flex flex-col justify-center items-center">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center space-y-4">
        ...
        />
        <button type="submit" className="px-6 py-2 rounded-lg bg-white text-black font-medium shadow-md hover:bg-black hover:text-white transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-primary">
          결과 보기
        </button>
      </form>
      {result && (
